...
// ╔══════════════════════════════════════════════════════════════╗
// ║       STUDENT RESULT MANAGEMENT SYSTEM (Single File)        ║
// ║  Java · OOP · Swing GUI · File Handling · Role-Based Auth   ║
// ╚══════════════════════════════════════════════════════════════╝
...
/**
 * Student — core model with marks, percentage, grade.
 * Demonstrates: Inheritance (extends User), Encapsulation.
 */
class Student extends User {
    ...
    /**
     * Grade based on percentage. Overridden in BacklogStudent (Polymorphism).
     */
    String assignGrade() {
...
/**
 * BacklogStudent — auto-created when any mark < 30.
 * Demonstrates: Multilevel Inheritance, Polymorphism (overrides assignGrade).
 * IS-A: BacklogStudent IS-A Student IS-A User.
 */
...
/**
 * Professor — can manage students and other professors.
...
// ═══════════════════════════════════════════════════════════════
//  GUI LAYER — Theme (Colors, Fonts, Custom Components)
// ═══════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════
//  GUI — Professor Dashboard (3 tabs)
// ═══════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════
//  GUI — Student Result Card (read-only)
// ═══════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════
//  GUI — Main Frame (CardLayout navigation)
// ═══════════════════════════════════════════════════════════════
